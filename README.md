...
$$V_{0,i} = \vec{d} \cdot (V_{0,i} - P), i \in \{0,1,2\}$$
...
$$
t_{0, i}=V_{0, i}^{\prime}+\left(V_{0,2}^{\prime}-V_{0, i}^{\prime}\right) \frac{\operatorname{dist}_{V_{0, i}}}{\operatorname{dist}_{V_{0, i}}-\operatorname{dist}_{V_{0,2}}}, \quad i \in\{0,1\}
$$
